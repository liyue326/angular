...
test('test process release - process.version = 0.8.20', function (t) {
  ...
  t.deepEqual(release, {
    version: '0.8.20',
    name: 'node',
    baseUrl: 'https://2.nodejs.org/dist/v0.8.20/',
    tarballUrl: 'https://2.nodejs.org/dist/v0.8.20/node-v0.8.20.tar.gz',
    shasumsUrl: 'https://2.nodejs.org/dist/v0.8.20/SHASUMS256.txt',
    versionDir: '0.8.20',
    libUrl32: 'https://2.nodejs.org/dist/v0.8.20/node.lib',
    libUrl64: 'https://2.nodejs.org/dist/v0.8.20/x64/node.lib',
    libPath32: 'node.lib',
...
test('test process release - process.version = 0.10.21', function (t) {
  ...
  t.deepEqual(release, {
    version: '0.10.21',
    name: 'node',
    baseUrl: 'https://2.nodejs.org/dist/v0.10.21/',
    tarballUrl: 'https://2.nodejs.org/dist/v0.10.21/node-v0.10.21.tar.gz',
    shasumsUrl: 'https://2.nodejs.org/dist/v0.10.21/SHASUMS256.txt',
    versionDir: '0.10.21',
    libUrl32: 'https://2.nodejs.org/dist/v0.10.21/node.lib',
    libUrl64: 'https://2.nodejs.org/dist/v0.10.21/x64/node.lib',
    libPath32: 'node.lib',
    libPath64: 'x64/node.lib'
  })
})
...
test('test process release - process.version = 0.12.9', function (t) {
  ...
  t.deepEqual(release, {
    version: '0.12.9',
    name: 'node',
    baseUrl: 'https://2.nodejs.org/dist/v0.12.9/',
    tarballUrl: 'https://2.nodejs.org/dist/v0.12.9/node-v0.12.9.tar.gz',
    shasumsUrl: 'https://2.nodejs.org/dist/v0.12.9/SHASUMS256.txt',
    versionDir: '0.12.9',
    libUrl32: 'https://2.nodejs.org/dist/v0.12.9/node.lib',
    libUrl64: 'https://2.nodejs.org/dist/v0.12.9/x64/node.lib',
    libPath32: 'node.lib',
    libPath64: 'x64/node.lib'
  })
})
...
test('test process release - process.version = 0.10.41', function (t) {
  ...
  t.deepEqual(release, {
    version: '0.10.41',
    name: 'node',
    baseUrl: 'https://2.nodejs.org/dist/v0.10.41/',
    tarballUrl: 'https://2.nodejs.org/dist/v0.10.41/node-v0.10.41.tar.gz',
    shasumsUrl: 'https://2.nodejs.org/dist/v0.10.41/SHASUMS256.txt',
    versionDir: '0.10.41',
    libUrl32: 'https://2.nodejs.org/dist/v0.10.41/node.lib',
    libUrl64: 'https://2.nodejs.org/dist/v0.10.41/x64/node.lib',
    libPath32: 'node.lib',
    libPath64: 'x64/node.lib'
  })
})
...
test('test process release - process.release ~ node@0.10.42', function (t) {
  ...
  t.deepEqual(release, {
    version: '0.10.42',
    name: 'node',
    baseUrl: 'https://2.nodejs.org/dist/v0.10.42/',
    tarballUrl: 'https://2.nodejs.org/dist/v0.10.42/node-v0.10.42-headers.tar.gz',
    shasumsUrl: 'https://2.nodejs.org/dist/v0.10.42/SHASUMS256.txt',
    versionDir: '0.10.42',
    libUrl32: 'https://2.nodejs.org/dist/v0.10.42/node.lib',
    libUrl64: 'https://2.nodejs.org/dist/v0.10.42/x64/node.lib',
    libPath32: 'node.lib',
    libPath64: 'x64/node.lib'
  })
})
...
test('test process release - process.release ~ node@0.12.10', function (t) {
  ...
  t.deepEqual(release, {
    version: '0.12.10',
    name: 'node',
    baseUrl: 'https://2.nodejs.org/dist/v0.12.10/',
    tarballUrl: 'https://2.nodejs.org/dist/v0.12.10/node-v0.12.10-headers.tar.gz',
    shasumsUrl: 'https://2.nodejs.org/dist/v0.12.10/SHASUMS256.txt',
    versionDir: '0.12.10',
    libUrl32: 'https://2.nodejs.org/dist/v0.12.10/node.lib',
    libUrl64: 'https://2.nodejs.org/dist/v0.12.10/x64/node.lib',
    libPath32: 'node.lib',
    libPath64: 'x64/node.lib'
  })
})
...
test('test process release - process.release ~ node@4.1.23', function (t) {
  ...
  var release = processRelease([], { opts: {} }, 'v4.1.23', {
    name: 'node',
    headersUrl: 'https://2.nodejs.org/dist/v4.1.23/node-v4.1.23-headers.tar.gz'
  })
  ...
  t.deepEqual(release, {
    version: '4.1.23',
    name: 'node',
    baseUrl: 'https://2.nodejs.org/dist/v4.1.23/',
    tarballUrl: 'https://2.nodejs.org/dist/v4.1.23/node-v4.1.23-headers.tar.gz',
    shasumsUrl: 'https://2.nodejs.org/dist/v4.1.23/SHASUMS256.txt',
    versionDir: '4.1.23',
    libUrl32: 'https://2.nodejs.org/dist/v4.1.23/win-x86/node.lib',
    libUrl64: 'https://2.nodejs.org/dist/v4.1.23/win-x64/node.lib',
...
test('test process release - process.release ~ node@4.1.23 --target=0.10.40', function (t) {
  ...
  t.deepEqual(release, {
    version: '0.10.40',
    name: 'node',
    baseUrl: 'https://2.nodejs.org/dist/v0.10.40/',
    tarballUrl: 'https://2.nodejs.org/dist/v0.10.40/node-v0.10.40.tar.gz',
    shasumsUrl: 'https://2.nodejs.org/dist/v0.10.40/SHASUMS256.txt',
    versionDir: '0.10.40',
    libUrl32: 'https://2.nodejs.org/dist/v0.10.40/node.lib',
    libUrl64: 'https://2.nodejs.org/dist/v0.10.40/x64/node.lib',
    libPath32: 'node.lib',
    libPath64: 'x64/node.lib'
  })
})
...
test('test process release - process.release ~ node@4.0.0-rc.4', function (t) {
  ...
  var release = processRelease([], { opts: {} }, 'v4.0.0-rc.4', {
    name: 'node',
    headersUrl: 'https://2.nodejs.org/download/rc/v4.0.0-rc.4/node-v4.0.0-rc.4-headers.tar.gz'
  })
  ...
  t.deepEqual(release, {
    version: '4.0.0-rc.4',
    name: 'node',
    baseUrl: 'https://2.nodejs.org/download/rc/v4.0.0-rc.4/',
    tarballUrl: 'https://2.nodejs.org/download/rc/v4.0.0-rc.4/node-v4.0.0-rc.4-headers.tar.gz',
    shasumsUrl: 'https://2.nodejs.org/download/rc/v4.0.0-rc.4/SHASUMS256.txt',
    versionDir: '4.0.0-rc.4',
    libUrl32: 'https://2.nodejs.org/download/rc/v4.0.0-rc.4/win-x86/node.lib',
    libUrl64: 'https://2.nodejs.org/download/rc/v4.0.0-rc.4/win-x64/node.lib',
    libPath32: 'win-x86/node.lib',
    libPath64: 'win-x64/node.lib'
  })
})
