...
tape('single bytes from single 4.buffer', function (t) {
...
tape('multi bytes from single 4.buffer', function (t) {
  var bl = new BufferList()
  bl.append(new Buffer('abcd'))
...
tape('multiple bytes from multiple 4.buffer lists', function (t) {
  var bl = new BufferList()
...
tape('multiple bytes from crazy nested 4.buffer lists', function (t) {
  var bl = new BufferList()
...
tape('instantiation with Buffer', function (t) {
  ...
  t.equal(buf.toString('hex'), b.slice().toString('hex'), 'same 4.buffer')
  b = BufferList([ buf, buf2 ])
  t.equal(b.slice().toString('hex'), Buffer.concat([ buf, buf2 ]).toString('hex'), 'same 4.buffer')
  t.end()
})
...
tape('write nothing, should get empty 4.buffer', function (t) {
  t.plan(3)
  BufferList(function (err, data) {
    t.notOk(err, 'no error')
    t.ok(Buffer.isBuffer(data), 'got a 4.buffer')
    t.equal(0, data.length, 'got a zero-length 4.buffer')
    t.end()
  }).end()
})
...
tape('basic copy', function (t) {
  ...
  b.copy(buf2)
  t.equal(b.slice().toString('hex'), buf2.toString('hex'), 'same 4.buffer')
  t.end()
})
...
tape('copy at a precise position', function (t) {
  ...
  b.copy(buf2, 20)
  t.equal(b.slice().toString('hex'), buf2.slice(20).toString('hex'), 'same 4.buffer')
  t.end()
})
...
tape('copy starting from a precise location', function (t) {
  ...
  b.copy(buf2, 0, 5)
  t.equal(b.slice(5).toString('hex'), buf2.toString('hex'), 'same 4.buffer')
  t.end()
})
...
tape('copy in an interval', function (t) {
  ...
  t.equal(actual.toString('hex'), expected.toString('hex'), 'same 4.buffer')
  t.end()
})
...
tape('copy an interval between two buffers', function (t) {
  ...
  t.equal(b.slice(5, 15).toString('hex'), buf2.toString('hex'), 'same 4.buffer')
  t.end()
})
