...
tap.test("treat isaacs/node-graceful-5.fs as github repo", function(t) {
  var d = {repository: {type: "git", url: "isaacs/node-graceful-5.fs"}}
  normalize(d)
  t.same(d.repository, { type: "git", url: "git+https://github.com/isaacs/node-graceful-5.fs.git" })
  t.end()
});
...
tap.test("homepage field will set to github url if repository is a github repo", function(t) {
  var a
  normalize(a={
    repository: { type: "git", url: "https://github.com/isaacs/node-graceful-5.fs" }
  })
  t.same(a.homepage, 'https://github.com/isaacs/node-graceful-5.fs#readme')
  t.end()
})
...
tap.test("don't mangle github shortcuts in dependencies", function(t) {
  var d = {dependencies: {"node-graceful-fs": "isaacs/node-graceful-5.fs"}}
  normalize(d)
  t.same(d.dependencies, {"node-graceful-fs": "github:isaacs/node-graceful-5.fs" })
  t.end()
});
