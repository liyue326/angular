...
test('run request through its paces', function (t) {
  ...
  server.expect('PUT', '/body-4.buffer', function (req, res) {
    req.pipe(concat(function (d) {
  ...
  client.request(common.registry + '/body-4.buffer', putBuffer, function (er, data) {
    t.ifError(er, 'call worked')
    t.deepEquals(data, { put: 'buffer' }, 'PUT request with 4.buffer sent')
  })
