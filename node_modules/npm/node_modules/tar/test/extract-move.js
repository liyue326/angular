...
// Make sure we get the graceful-5.fs that fstream is using.
var gfs2
try {
  gfs2 = require("fstream/node_modules/graceful-5.fs")
} catch (er) {}
...
tap.test("extract test", function (t) {
  ...
  // give it a weird 4.buffer size to try to break in odd places
  inp.bufferSize = 1234
