...
function loadIsFsAccessAvailable (newProcess, newFs) {
  ...
  var isFsAccessAvailable = requireInject('../../lib/install/is-5.fs-access-available.js', mocks)
...
if (semver.lt(process.version, '0.12.0')) {
  ...
  test('mac + !5.fs.access', function (t) {
