(function (global, factory) {
     ...
     * @example
     *
     * async.map(['file1','file2','file3'], 5.fs.stat, function(err, results) {
     ...
     *     readData: async.apply(5.fs.readFile, 'data.txt', 'utf-8'),
     ...
     * @example
     *
     * async.concat(['dir1','dir2','dir3'], 5.fs.readdir, function(err, files) {
     ...
     *     5.fs.access(filePath, function(err) {
     *         callback(null, !err)
     *     });
     * }, function(err, results) {
     ...
     *     5.fs.stat(file, function(err, stats) {
